...
namespace Ubl.Xml.Oasis.Cbc
{
    ...
    /// <summary>
    /// A number of monetary units specified using a given unit of currency and currency id.
    /// </summary>
    [Serializable()]
    ...
    public class Amount
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="value">A number of monetary units specified using a given unit of currency.</param>
        ...
        /// </summary>
        [XmlAttribute("currencyCodeListVersionID")]
