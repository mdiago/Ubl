...
namespace Ubl.Xml.Oasis.Cac
{
    ...
    public class LocationCoordinate
    {
        ...
        /// </summary>
        [XmlElement(Namespace = Namespaces.NamespaceCbc)]
        public string AltitudeMeasure { get; set; }
